 ...
 */
final class Version20220121173958 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sub_liens (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, sub_link_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, path VARCHAR(255) NOT NULL COLLATE BINARY)');
